...
public class Facebook : IFacebook
{
    ...
    {
        var url = $"/oauth/access_token?grant_type=fb_exchange_token&client_id={"489200890400050"}&client_secret={"2196bc19ee4d6848df97b48ad8570c5b"}&fb_exchange_token={accessToken}";
